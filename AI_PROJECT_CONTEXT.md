...
2. 首页展示第 4 关调研中确认的站点介绍、官方入口、SEO 信息和导航。
...
- 内容格式：MDX。
- 首期语言：English；日语、德语、西语仅保留语言配置，尚未发布翻译。
...
| 路由 | 用途 |
| --- | --- |
| `/` | 首页：Hero、起步导航、游戏介绍、兑换码状态、最终 CTA、官方入口。 |
...
- 无法从来源确认的内容必须写 `To be confirmed`；兑换码没有确认来源时写“暂无”。
...
2. 新的游戏事实是否有至少一个可追溯来源？没有则标 `To be confirmed`。
...
7. 提交前复核：来源、SEO 字符数、待确认标记和非官方声明仍然正确。

## 目前已知缺口

- 法律页面的正式内容尚未提供，页脚显示“待确认”。
- 非英文翻译尚未制作。
- 兑换码没有已确认来源，因此首页显示“暂无”。
- 部分攻略内的版本、掉率、价格、解锁与库存细节仍需官方材料或当前游戏内验证。
- 部署、域名和生产环境配置尚未完成。
